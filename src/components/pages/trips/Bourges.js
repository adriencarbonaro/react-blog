...
Nous avions réservé un Airbnb idéalement situé juste derrière la cathédrale.
...
Nous nous sommes rendus chez Jean-Marc & Mathieu Crochet, un vignoble tenu de père en fils.
...
Nous avons dégusté de succulentes tartines de chèvre chaud au “Café des Arts” situé sur la petite place. 
...
Après plusieurs tentatives, les cafés étant très prisés pour l’heure de goûter, nous avons dégoté une petite table chez “Délichou !” une tarterie beaucoup trop mignonne.
...
class P5 extends Component {
	render () {
		return (
			<>
Rangement du Airbnb puis direction “Délichou !” pour un brunch incroyable.
