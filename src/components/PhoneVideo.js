const PHONE_SIZE         = "500px";
const PHONE_SCREEN_SCALE = "1.66";


function Phone(props) {
	return (
<svg height={PHONE_SIZE} class="svg-clip" id="bf5f4b72-f966-4f0c-8662-2e23ed4682a3" data-name="svg8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 148.78 300.25">
	<defs>
	...
	<g id="fdb73e5f-6047-4e3b-bd26-e53a83a485f9" data-name="layer2">
		...
		<clipPath id="mask">
			<path
			id="e2d14410-771d-402a-b5ac-6848ff62a26a"
			data-name="path998"
			class="bb58df6f-0ad3-41e8-9ddc-8fb28eb9e285"
			d="M24.45,7.17A15.65,15.65,0,0,0,8.8,22.82v254.7a15.65,15.65,0,0,0,15.65,15.65H125.22a15.65,15.65,0,0,0,15.65-15.65V22.82A15.65,15.65,0,0,0,125.22,7.17H105.13c-1.83,0-2.77.19-2.77,3.09s-1.8,7.79-8.23,7.79H55.55c-6.44,0-8.23-4.89-8.23-7.79s-1-3.09-2.78-3.09Z"
			transform={" scale(" + PHONE_SCREEN_SCALE + ") translate(-0.45 -0.04)"}/>
		</clipPath>
	</g>
</svg>
	)
		...
		<>
			<div class="clip-cont">
				...
				<video height={PHONE_SIZE} class="svg-clip-video" id="video1" loop controls>
					<source src="https://nid-de-poule.s3.eu-west-3.amazonaws.com/amsterdam.mp4" type="video/mp4"/>
				</video>
			</div>
		</>
	);
